...
import ClienteRepository from '../../../database/repositories/ProductRepository.js';
...
export default class MainWindowFactory {
    ...
    static createWindow() {
        ...
        ipcMain.handle('cliente:save', async (_event, productData) => {
            return await ClienteRepository.insert(productData);
        });
